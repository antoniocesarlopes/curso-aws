...
public class Service01Stack extends Stack {
	...
	public Service01Stack(final Construct scope, final String id, final StackProps props, Cluster cluster, SnsTopic productEventsTopic) {
		...
		+ ":3306/aws_project01?createDatabaseIfNotExist=true&useTimezone=true&serverTimezone=UTC");
		...
		ApplicationLoadBalancedFargateService service01 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB01")
				...
				.desiredCount(2)
				.listenerPort(8080)
				.assignPublicIp(true) //solução para reduzir custos, devido a não termos uma gateway, precisamos adicionar um ip publico 
				.taskImageOptions(
						ApplicationLoadBalancedTaskImageOptions.builder()
						.containerName("aws-project01")
						.image(ContainerImage.fromRegistry("antoniocesarlopes/aws-project01:0.0.3"))
						.containerPort(8080)
